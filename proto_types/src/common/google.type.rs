...
///
/// The date and time zone are either not significant
...
pub mod date_time {
  ...
  pub enum TimeOffset {
    ...
    /// { seconds: -14400 }.
    #[prost(message, tag = "8")]
    UtcOffset(crate::protobuf::Duration),
    /// Time zone.
    #[prost(message, tag = "9")]
...
pub struct Interval {
  ...
  pub start_time: ::core::option::Option<crate::protobuf::Timestamp>,
  /// Optional. Exclusive end of the interval.
  ///
  /// If specified, a Timestamp matching this interval will have to be before the
  /// end.
  #[prost(message, optional, tag = "2")]
  pub end_time: ::core::option::Option<crate::protobuf::Timestamp>,
}
...
pub mod phone_number {
  ...
  /// Required.  Either a regular number, or a short code.
  ///
  /// New fields may be
  /// added to the oneof below in the future, so clients should ignore phone
  /// numbers for which none of the fields they coded against are set.
