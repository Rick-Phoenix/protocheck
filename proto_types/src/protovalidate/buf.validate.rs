// This contents of this file have been extracted from [protovalidate](https://github.com/bufbuild/protovalidate), licensed under the Apache-2.0 license.
//
// This file is @generated by prost-build.
/// `Rule` represents a validation rule written in the Common Expression
/// Language (CEL) syntax.
///
/// Each Rule includes a unique identifier, an
...
///
/// This message type is returned by
...
///
/// It provides information about the field that
