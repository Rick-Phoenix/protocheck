...
pub(crate) fn get_gt_rule_path(kind: &ProtoType) -> (&str, Vec<FieldPathElement>) {
  match kind {
    ProtoType::Float => ("float", FLOAT_GT_VIOLATION.clone()),
    ProtoType::Double => ("double", DOUBLE_GT_VIOLATION.clone()),
    ProtoType::Int32 => ("int32", INT32_GT_VIOLATION.clone()),
    ProtoType::Int64 => ("int64", INT64_GT_VIOLATION.clone()),
    ProtoType::Uint32 => ("uint32", UINT32_GT_VIOLATION.clone()),
    ProtoType::Uint64 => ("uint64", UINT64_GT_VIOLATION.clone()),
    ProtoType::Sint32 => ("sint32", SINT32_GT_VIOLATION.clone()),
    ProtoType::Sint64 => ("sint64", SINT64_GT_VIOLATION.clone()),
    ProtoType::Fixed32 => ("fixed32", FIXED32_GT_VIOLATION.clone()),
    ProtoType::Fixed64 => ("fixed64", FIXED64_GT_VIOLATION.clone()),
    ProtoType::Sfixed32 => ("sfixed32", SFIXED32_GT_VIOLATION.clone()),
    ProtoType::Sfixed64 => ("sfixed64", SFIXED64_GT_VIOLATION.clone()),
    _ => ("", vec![]),
  }
}
