...
//! You do not need to use this crate directly. Refer to [`protocheck`] to learn more about how to set up automatic validators generation for structs generated from protobuf definitions.
