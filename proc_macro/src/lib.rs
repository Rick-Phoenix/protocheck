...
//! # Protocheck
//!
//! This crate is used by [`protocheck-build`](https://docs.rs/protocheck-build/0.1.0/protocheck_build/) to add the [`validate`](https://docs.rs/protocheck/0.1.0/protocheck/trait.ProtoValidator.html#tymethod.validate) method and the [`ProtoValidator`](https://docs.rs/protocheck/0.1.0/protocheck/trait.ProtoValidator.html) trait to protobuf messages and oneofs. You will never use this crate directly as [`protocheck-build`](https://docs.rs/protocheck-build/0.1.0/protocheck_build/) takes care of adding the macros to your generated messages. Refer to [`protocheck`](https://docs.rs/protocheck/0.1.0/protocheck/) for how to use the validators generated by this crate.
