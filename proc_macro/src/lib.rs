//! # Protocheck
//!
//! This crate is used by [`protocheck-build`](::protocheck-build) to add the [`validate`](::protocheck::ProtoValidator::validate) method and the [`ProtoValidator`](::protocheck::ProtoValidator) trait to protobuf messages and oneofs. You will never use this crate directly as [`protocheck-build`](::protocheck-build) takes care of adding the macros to your generated messages. Refer to [`protocheck`](::protocheck) for how to use the validators generated by this crate.
