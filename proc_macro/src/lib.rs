//! # Protocheck
//!
//! This crate is used by [`protocheck-build`] to add the [`validate`] method and the [`protocheck::ProtoValidator`] trait to protobuf messages and oneofs. You will never use this crate directly as [`protocheck-build`] takes care of adding the macros to your generated messages. Refer to [`protocheck-core`] for how to use the validators generated by this crate.
