  ...
  T: Copy + ComparableError,
{
  ...
  pub fn error_message(&self) -> String {
    ...
    match self {
      Self::Lt(_) => format!("must be {smaller_adjective} than {value_str}"),
      Self::Lte(_) => {
  ...
  T: Copy + ComparableError,
{
  ...
  pub fn error_message(&self) -> String {
    ...
    match self {
      Self::Gt(_) => format!("must be {greater_adjective} than {value_str}"),
      Self::Gte(_) => {
